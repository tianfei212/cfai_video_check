    ...
    <div className="max-w-7xl mx-auto py-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between mb-8 px-2">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-[#1D1D1F]">关键帧采样序列分析</h1>
            <div className="flex items-center gap-3 mt-1">
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">项目编号: CAFAI-{id || '1024'} · 深度采样模式</p>
            </div>
          </div>
        </div>
        <div className="flex gap-3">
          <button className="px-6 py-3 bg-white border border-gray-100 rounded-2xl text-xs font-bold hover:bg-gray-50 transition-all">导出分析报告 (PDF/XML)</button>
          <button 
      ...
      <div className="apple-card bg-white border-gray-100 flex flex-col h-[75vh] overflow-hidden shadow-2xl shadow-black/[0.02]">
        ...
        <div className="grid grid-cols-[1.5fr_1.2fr_2.5fr_1.2fr] px-10 py-5 bg-gray-50/50 border-b border-gray-50 shrink-0">
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">时间轴索引</span>
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] text-center">开始帧 (START)</span>
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] text-center">AI 核心采样 (KEYFRAME)</span>
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] text-right pr-4">结束帧 (END)</span>
        </div>
        ...
        <div className="px-10 py-6 bg-gray-900 text-white flex justify-between items-center shrink-0">
          <div className="flex gap-12">
            <div className="flex flex-col">
              <span className="text-[9px] font-bold text-white/30 uppercase tracking-widest mb-1">采样密度</span>
              <span className="text-base font-bold tracking-tight">2.4 Keyframes / Sec</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[9px] font-bold text-white/30 uppercase tracking-widest mb-1">色彩空间一致性</span>
              <span className="text-base font-bold tracking-tight text-green-400">PASSED</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[9px] font-bold text-white/30 uppercase tracking-widest mb-1">总计提取</span>
              <span className="text-base font-bold tracking-tight">12.4 GB 序列数据</span>
            </div>
          </div>
          <div className="text-right">
             <p className="text-[10px] text-white/40 font-bold uppercase tracking-widest mb-1">检测集群状态</p>
